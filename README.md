...
# Step4
<h3>بخش اول</h3>
<p>از انجام دادن همه تغییرات معاف می‌شویم به علت این که همه این تغییرات را در بخش‌های ۲ و ۳ اعمال کرده ایم و در حال حاضر پروژه ‌ما با اصول solid منطبق است.</p>
<h3>بخش دوم</h3>
<p>هیچ تغییری چون کد ما در حال حاضر اصول solid نقض نشده‌اند که بخواهیم تغییری من باب درست کردن آن انجام دهیم.</p>
